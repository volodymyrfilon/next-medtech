  ...
  return (
    ...
    >
      ...
      <Card
        ...
        subtitle="
        Після першої нашої зустрічі ви ділитеся своїми викликами та тим, що б хотіли змінити. Разом ми встановлюємо ціль та працюємо над досягненням її на протязі кількох наступних зустрічей. Кожна зустріч має свою унікальну мету, і після кожної ви отримуєте конкретні результати, що допомагають вам розширити розуміння ситуації та розвинути стратегії для подальших кроків. Наша співпраця - це взаємодія та рух у напрямку вашого особистісного зростання і досягнення мети, яка має значення для вас:"
        link="/#feedbacks"
        buttonEnd={false}
      >
